...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR 10   // Babysteps are very small. Increase for faster motion. // TODO: Change maybe, was changed from 1
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     330  // (mm) Slow length, to allow time to insert material.
